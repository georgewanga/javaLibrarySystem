...
public class SearchBooksAndMembers extends JInternalFrame {
    ...
    //for creating String[]
    private final String[] membersTypes = {"FirstName", "MiddleName", "Surname", "PostalAddress", "PhoneNumbe", "AltPhoneNumber", "EmailAddress", "Username", "DateAdded", "NumberOfBooks"};
    //for creating the label
        ...
        searchBooksButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (isBooksDataCorrect()) {
                    book = new Books();
                    String bookQuery = "SELECT * FROM wspslibrary.availableBooks WHERE  " + booksData[0] + " LIKE  '" + booksData[1] + "'";
                    book.connection(bookQuery);
                    String SerialNo = book.getSerialNo();
                    if (!SerialNo.equalsIgnoreCase(null)) {
        ...
        searchMembersButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (isMembersDataCorrect()) {
                    member = new Members();
                    String memberQuery = "SELECT FirstName, MiddleName, Surname, PostalAddress, PhoneNumber, AltPhoneNumber, EmailAddress, DateAdded, NumberOfBooks FROM wspslibrary.users WHERE  " + membersData[0] + " LIKE  '" + membersData[1] + "'";
